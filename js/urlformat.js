window.onload = function () {
    if(location.origin != "file://") {
        ...
        //Other Items
        if(document.getElementById("beginbuttonref") != null) {
            document.getElementById("beginbuttonref").setAttribute("href", "about.html");
        }
        if(document.getElementById("contactinforef") != null) {
            document.getElementById("contactinforef").setAttribute("href", "contact.html");
        }
        if(document.getElementById("questionsref") != null) {
            document.getElementById("questionsref").setAttribute("href", "contact.html");
        }
    }
}